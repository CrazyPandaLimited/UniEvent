...
public:
    using connect_fptr = void(Stream* handle, const StreamError& err, ConnectRequest* req);
...
public:
    using shutdown_fptr = void(Stream* handle, const StreamError& err, ShutdownRequest* req);
...
class WriteRequest : public BufferRequest, public AllocatedObject<WriteRequest, true> {
    uv_write_t uvr;
public:
    using write_fptr = void(Stream* handle, const StreamError& err, WriteRequest* req);
...
class SendRequest : public BufferRequest, public AllocatedObject<SendRequest, true> {
    uv_udp_send_t uvr;
public:
    using send_fptr = void(UDP* handle, const UDPError& err, SendRequest* req);
