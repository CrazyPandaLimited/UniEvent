...
void StreamFilter::handle_connection (const StreamSP& client, const std::error_code& err, const AcceptRequestSP& req) {
...
void StreamFilter::handle_connect (const std::error_code& err, const ConnectRequestSP& req) {
    INVOKE(prev, handle_connect, finalize_handle_connect, err, req);
}

void StreamFilter::handle_read (string& buf, const std::error_code& err) {
...
void StreamFilter::handle_write (const std::error_code& err, const WriteRequestSP& req) {
...
void StreamFilter::handle_shutdown (const std::error_code& err, const ShutdownRequestSP& req) {
